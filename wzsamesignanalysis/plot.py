...
def Draw(name = 'Lep0Pt_eee_lep', rebin = 1, xtit = '', ytit = 'Events', doStackOverflow = False, binlabels = '', setLogY = False, maxscale = 2, tag = False):
  ...
  if tag == False:
    ...
    if type(name) == type([]):
      tag = tag.replace("ee","all").replace("me","all").replace("mm","all")
  s.SetOutName(tag)
...
joblist = []
#lev = 'met' #lep, met
for lev in ['lep','tight'] :#, 'm3l','wpt','htmiss']:
  for ch in ['ee','me','mm','All']:
 #joblist.append(Draw(GetAllCh('htmiss', lev), 1, 'H_{T}^{miss} (GeV)', 'Events / 5 GeV')
    if ch == 'All':
      ...
      joblist.append(Draw(GetAllCh('HTmiss', lev), 1, 'H_{T}^{miss} (GeV)', 'Events / 5 GeV'))
      joblist.append(Draw(GetAllCh('DilepPt', lev), 1, 'p_{T}^{ll} (GeV)', 'Events / 5 GeV'))
      joblist.append(Draw(GetAllCh('MET', lev), 1, 'p_{T}^{miss} (GeV)', 'Events / 5 GeV'))
      joblist.append(Draw(GetAllCh('Lep0Pt', lev), 1, 'p_{T}(lep0Z)  (GeV)', 'Events / 40 GeV'))
      joblist.append(Draw(GetAllCh('Lep0Eta', lev), 1, '#eta (lep0Z)', 'Events'))
      joblist.append(Draw(GetAllCh('Lep0Phi', lev), 1, '#phi (lep0Z) (rad/#pi)', 'Events'))
      joblist.append(Draw(GetAllCh('Lep1Pt', lev), 1, 'p_{T}(lep1Z)  (GeV)', 'Events / 40 GeV'))
      joblist.append(Draw(GetAllCh('Lep1Eta', lev), 1, '#eta (lep1Z)', 'Events'))
      joblist.append(Draw(GetAllCh('Lep1Phi', lev), 1, '#phi (lep1Z) (rad/#pi)', 'Events'))
      joblist.append(Draw(GetAllCh('MaxDeltaPhi', lev), 1, 'max(#Delta#phi (ll)) (rad/#pi)', 'Events'))
      joblist.append(Draw(GetAllCh('MaxDeltaR', lev), 1, 'max(#DeltaR (ll)) (rad/#pi)', 'Events'))
      joblist.append(Draw(GetAllCh('NJets', lev), 1, 'Jet multiplicity', 'Events', True))
      joblist.append(Draw(GetAllCh('l0_genFlavor', lev), 1, 'Generator Flavor (lepZ0)', 'Events'))
      joblist.append(Draw(GetAllCh('l1_genFlavor', lev), 1, 'Generator Flavor (lepZ1)', 'Events'))
      joblist.append(Draw(GetAllCh('InvMass', lev), 1, 'M_{ll}', 'Events'))
      ...
      joblist.append(Draw(GetName('DilepPt', ch, lev), 1, 'p_{T}^{ll} (GeV)', 'Events / 5 GeV'))
      joblist.append(Draw(GetName('MET',ch, lev), 1, 'p_{T}^{miss} (GeV)', 'Events / 5 GeV'))
      joblist.append(Draw(GetName('Lep0Pt',ch, lev), 1, 'p_{T}(lep0Z)  (GeV)', 'Events / 40 GeV'))
      joblist.append(Draw(GetName('Lep0Eta',ch, lev), 1, '#eta (lep0Z)', 'Events'))
      joblist.append(Draw(GetName('Lep0Phi',ch, lev), 1, '#phi (lep0Z) (rad/#pi)', 'Events'))
      joblist.append(Draw(GetName('Lep1Pt',ch, lev), 1, 'p_{T}(lep1Z)  (GeV)', 'Events / 40 GeV'))
      joblist.append(Draw(GetName('Lep1Eta',ch, lev), 1, '#eta (lep1Z)', 'Events'))
      joblist.append(Draw(GetName('Lep1Phi',ch, lev), 1, '#phi (lep1Z) (rad/#pi)', 'Events'))
      joblist.append(Draw(GetName('MaxDeltaPhi',ch, lev), 1, 'max(#Delta#phi (ll)) (rad/#pi)', 'Events'))
      joblist.append(Draw(GetName('MaxDeltaR',ch, lev), 1, 'max(#DeltaR (ll)) (rad/#pi)', 'Events'))
      joblist.append(Draw(GetName('NJets',ch, lev), 1, 'Jet multiplicity', 'Events', True))
      joblist.append(Draw(GetName('l0_genFlavor',ch, lev), 1, 'Generator Flavor (lepZ0)', 'Events'))
      joblist.append(Draw(GetName('l1_genFlavor',ch, lev), 1, 'Generator Flavor (lepZ1)', 'Events'))
      joblist.append(Draw(GetName('InvMass',ch, lev), 1, 'M_{ll}', 'Events'))
